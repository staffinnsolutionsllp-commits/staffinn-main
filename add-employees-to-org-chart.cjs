 ...
 * 
 * This script helps you quickly add all employees to the organization chart
 * with a simple hierarchy structure.
 */
...
const { generateId, getCurrentTimestamp } = require('./Backend/utils/hrmsHelpers');
...
async function addEmployeesToOrgChart() {
  ...
  try {
    ...
    console.log('   1. Go to HRMS → Organization Chart');
    console.log('   2. Reorganize employees according to your hierarchy');
    console.log('   3. Test the Grievances module again\n');
