...
namespace SBXPCSampleCSharp
{
    public partial class frmTrMode : Form
    {
        ...
        private void cmdRead_Click(object sender, EventArgs e)
        {
            ...
            int nAddr = AddrOftrModeInfo.ToInt32();

            bRet = bpc.GetDeviceLongInfo(Program.gMachineNumber, 5, ref nAddr);
        ...
        private void cmdWrite_Click(object sender, EventArgs e)
        {
            ...
            bRet = bpc.SetDeviceLongInfo(Program.gMachineNumber, 5, ref nAddr);
