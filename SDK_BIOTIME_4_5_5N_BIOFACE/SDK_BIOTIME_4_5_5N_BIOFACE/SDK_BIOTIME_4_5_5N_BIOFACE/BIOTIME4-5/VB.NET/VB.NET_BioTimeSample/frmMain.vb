...
Friend Class frmMain
    ...
    Private Sub cmdOpen_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdOpen.Click
        ...
        If optNetworkDevice.Checked = True Then
            ...
            If BioTime.ConnectTcpip(gMachineNumber, lpszIPAddress, CInt(txtPortNo.Text), CInt(txtPassword.Text)) = True Then
                mOpenFlag = True
        ...
        If optSerialDevice.Checked = True Then
            If BioTime.ConnectSerial(gMachineNumber, cmbComPort.SelectedIndex + 1, CInt(cmbBaudrate.Text)) = True Then
                mOpenFlag = True
                cmdOpen.Enabled = False
                cmdClose.Enabled = True
                cmdEnrollData.Enabled = True
        ...
        If optUSBDevice.Checked = True Then
            If BioTime.ConnectSerial(gMachineNumber, 0, 0) = True Then
                mOpenFlag = True
                cmdOpen.Enabled = False
                cmdClose.Enabled = True
                cmdEnrollData.Enabled = True
    ...
    Private Sub BioTime_OnReceiveEventXML(ByVal sender As System.Object, ByVal e As AxSBXPCLib._DSBXPCEvents_OnReceiveEventXMLEvent)
        frmEvent.ReceiveEventXML(e.lpszEventXML)
    End Sub
