...
Module mdlPublic
    ...
    Public Function MakeXMLCommandHeader(ByVal request As String) As String
        ...
        frmMain.BioTime.XML_AddString(MakeXMLCommandHeader, "REQUEST", request)
        frmMain.BioTime.XML_AddString(MakeXMLCommandHeader, "MSGTYPE", "request")
        frmMain.BioTime.XML_AddInt(MakeXMLCommandHeader, "MachineID", frmMain.gMachineNumber)
    End Function
