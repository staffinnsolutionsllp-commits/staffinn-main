VERSION 5.00
Begin VB.Form frmDaigong 
   Caption         =   "Daigong Depart"
   ClientHeight    =   8055
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   10455
...
Private Sub cmdRead_Click()
    ...
    For i = 0 To DEPARTMENT_COUNT - 1
        bRet = frmMain.SB100BPC1.GetDepartName(frmMain.gMachineNumber, i + 1, 1, str)
...
Private Sub cmdWrite_Click()
    ...
    bSuccess = True
    For i = 0 To DEPARTMENT_COUNT - 1
        bRet = frmMain.SB100BPC1.SetDepartName(frmMain.gMachineNumber, i + 1, 1, DbDepart(i))
