...
export const validateRecruiterForm = (formData) => {
  ...
  const websiteErrors = validateWebsite(formData.website);
  if (websiteErrors.length > 0) errors.website = websiteErrors[0];
...
export const validateInstituteForm = (formData) => {
  ...
  const regNumberErrors = validateRegistrationNumber(formData.registrationNumber);
  if (regNumberErrors.length > 0) errors.registrationNumber = regNumberErrors[0];
