...
const BlockedUser = ({ user, onClose }) => {
  ...
  if (submitSuccess) {
    return (
      <div className="blocked-user-overlay">
        <div className="blocked-user-container success">
          <div className="blocked-icon success-icon">
            <i className="fas fa-check-circle"></i>
          </div>
          <h1>Request Submitted Successfully!</h1>
          <p>Your help request has been sent to the administrators.</p>
          <p>You will be contacted soon regarding your account status.</p>
          <button 
      ...
      <div className="blocked-user-container">
        {!showRequestForm ? (
          <>
            ...
            <h1>You are blocked from Staffinn</h1>
            <p>Your account has been temporarily restricted. If you believe this is an error or would like to request assistance, please click the button below.</p>
