    ...
    return (
        <div className="institute-dashboard">
            ...
            {showModal && (modalType === 'course' || modalType === 'editCourse') && (
                <div className="institute-modal-overlay" onClick={closeModal}>
                    <div className="institute-modal-content large-modal" onClick={(e) => e.stopPropagation()}>
                        <div className="institute-modal-header">
                        ...
                        <form onSubmit={handleCourseSubmit} className="institute-modal-form">
                            {modalType === 'editCourse' && courseForm.modules && courseForm.modules.length > 0 && (
                                <div style={{padding: '10px', backgroundColor: '#e8f5e9', borderRadius: '4px', marginBottom: '15px'}}>
                                    <strong style={{color: '#2e7d32'}}>Editing Course:</strong> {courseForm.name}
                            ...
                            {/* Course Modules Section - Only for Online Mode */}
                            ...
                            {/* On Campus Files - Only for On Campus Mode */}
                            {courseForm.mode === 'On Campus' && (
                                <div className="institute-form-group">
                                    <label>Course Files (Images/Videos)</label>
                                    <input
                                        type="file"
                                        accept="image/*,video/*"
                                        multiple
                                        onChange={(e) => setCourseForm({...courseForm, onCampusFiles: Array.from(e.target.files)})}
                                    />
                                    {courseForm.onCampusFiles && courseForm.onCampusFiles.length > 0 && (
                                        <p style={{marginTop: '8px', fontSize: '0.9rem', color: '#666'}}>
                                            {courseForm.onCampusFiles.length} file(s) selected
                                        </p>
                                    )}
                                </div>
                            )}
