 ...
 * @desc Upload office location image to S3 (returns URL only, no DB update)
 * @access Private (Recruiter only)
 */
router.post('/upload-location-image', authenticate, upload.single('locationImage'), recruiterController.uploadLocationImage);
