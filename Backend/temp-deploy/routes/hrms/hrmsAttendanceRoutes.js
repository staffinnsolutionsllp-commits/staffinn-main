...
// Employee-Device Mapping routes
router.post('/mappings', authorizeRoles('admin', 'hr'), createMapping);
router.get('/mappings', getMappings);
router.delete('/mappings/:mappingId', authorizeRoles('admin', 'hr'), deleteMapping);

// Device Management routes
router.post('/devices', authorizeRoles('admin', 'hr'), registerDevice);
router.get('/devices', getDevices);
router.put('/devices/:deviceId/sync', updateDeviceSync);
